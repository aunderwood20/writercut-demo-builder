...
function demoBuilderPage() {
  ...
  if (!session) {
    return `<div class="page">${shellHero({ eyebrow: "WRITERCUT DEMO BUILDER", title: `<span class="gold">You wrote</span> the song.<br>Now let it <span class="gold">be heard.</span>`, body: "Bring your original lyrics and direction. WriterCut helps shape a private, AI-assisted demo up to four minutes.", word: "Demo", actions: `<a class="button button-gold" href="#/login?from=/demo-builder">Sign in to build</a><a class="button button-ghost" href="#/pricing">See demo pricing</a>` })}<div class="piano-divider"></div><section class="section"><div class="wrap pricing-grid"><article class="price-card featured"><span class="best-value">Best value</span><span class="price-label">Ten demo credits</span><div class="price"><strong>$39.99</strong></div><p>Ten private AI-assisted demos. No subscription.</p><ul class="check-list"><li>Up to four minutes each</li><li>Credits stay with your account</li><li>Clear AI Demo Disclosure</li><li>No artist imitation</li></ul><a class="button button-gold button-wide" href="#/login?from=/demo-builder">Sign in to continue</a></article><article class="price-card"><span class="price-label">One demo credit</span><div class="price"><strong>$4.99</strong></div><p>Buy only what you need.</p><ul class="check-list"><li>No free first generation</li><li>No automatic renewal</li><li>Technical failures refunded</li></ul></article></div></section></div>`;
  }
